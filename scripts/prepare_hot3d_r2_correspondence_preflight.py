...
def _a800_contract(summary: dict[str, Any]) -> str:
    ...
    raw_manifest = target_paths["raw_manifest"]
...
- `{target_paths['gt_sidecar_evaluation_only']}`
...
def parse_args() -> argparse.Namespace:
    ...
    default_run = ROOT / "v19_runs" / f"{date_tag}_hot3d_clip001851_r2_correspondence_a800_v1"
