...
def build(args: argparse.Namespace) -> dict[str, Any]:
    ...
    expected_blocker_states = {"blocked_articulation_hypothesis_not_fitted": 2, "blocked_part_model_residual_probes_rejected": 1}
    check(checks, "part_articulation_hypotheses_blocked_not_promoted", part_models.get("object_state_counts") == expected_model_states and part_blockers.get("part_object_blocker_state_counts") == expected_blocker_states and part_models.get("articulation_hypothesis_pair_count") == part_blockers.get("articulation_hypothesis_pair_count") == manifest.get("part_articulation_hypothesis_pair_count") == 2 and manifest.get("articulation_model_ready_count") == 0 and manifest.get("part_pose_ready_count") == 0, {"model_states": part_models.get("object_state_counts"), "blocker_states": part_blockers.get("part_object_blocker_state_counts"), "model_articulation_pairs": part_models.get("articulation_hypothesis_pair_count"), "blocker_articulation_pairs": part_blockers.get("articulation_hypothesis_pair_count"), "manifest_articulation_pairs": manifest.get("part_articulation_hypothesis_pair_count"), "articulation_ready": manifest.get("articulation_model_ready_count"), "part_pose_ready": manifest.get("part_pose_ready_count")}, {"model_states": expected_model_states, "blocker_states": expected_blocker_states, "articulation_pairs": 2, "ready": 0})
