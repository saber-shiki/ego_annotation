...
def build(args: argparse.Namespace) -> dict[str, Any]:
    ...
    expected_blocker_states = {"blocked_articulation_fit_residual_rejected": 1, "blocked_articulation_fit_supported_no_pose": 1, "blocked_part_model_residual_probes_rejected": 1}
    check(checks, "part_articulation_fit_diagnostics_not_promoted", part_models.get("object_state_counts") == expected_model_states and articulation_fit.get("articulation_fit_state_counts") == expected_fit_states and part_blockers.get("part_object_blocker_state_counts") == expected_blocker_states and part_models.get("articulation_hypothesis_pair_count") == part_blockers.get("articulation_hypothesis_pair_count") == manifest.get("part_articulation_hypothesis_pair_count") == articulation_fit.get("articulation_fit_probe_count") == manifest.get("articulation_fit_probe_count") == 2 and articulation_fit.get("articulation_fit_supported_count") == manifest.get("articulation_fit_supported_count") == 1 and articulation_fit.get("articulation_fit_rejected_count") == manifest.get("articulation_fit_rejected_count") == 1 and manifest.get("articulation_model_ready_count") == 0 and manifest.get("part_pose_ready_count") == 0, {"model_states": part_models.get("object_state_counts"), "fit_states": articulation_fit.get("articulation_fit_state_counts"), "blocker_states": part_blockers.get("part_object_blocker_state_counts"), "model_articulation_pairs": part_models.get("articulation_hypothesis_pair_count"), "fit_probe_count": articulation_fit.get("articulation_fit_probe_count"), "manifest_articulation_pairs": manifest.get("part_articulation_hypothesis_pair_count"), "manifest_fit_probe_count": manifest.get("articulation_fit_probe_count"), "fit_supported": articulation_fit.get("articulation_fit_supported_count"), "manifest_fit_supported": manifest.get("articulation_fit_supported_count"), "fit_rejected": articulation_fit.get("articulation_fit_rejected_count"), "manifest_fit_rejected": manifest.get("articulation_fit_rejected_count"), "articulation_ready": manifest.get("articulation_model_ready_count"), "part_pose_ready": manifest.get("part_pose_ready_count")}, {"model_states": expected_model_states, "fit_states": expected_fit_states, "blocker_states": expected_blocker_states, "articulation_pairs": 2, "fit_supported": 1, "fit_rejected": 1, "ready": 0})
