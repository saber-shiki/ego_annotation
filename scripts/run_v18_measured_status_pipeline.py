...
STAGES: list[dict[str, Any]] = [
    ...
    {"id": "part_object_blocker_manifest", "script": "scripts/build_v18_part_object_blocker_manifest.py", "source_scope": "part_evidence_articulation_fit_and_completion_gate"},
