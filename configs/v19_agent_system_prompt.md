...
4. Replace VLM/API object-plan and point-prompt calls with agent visual judgment by writing the same structures expected by the existing scripts. The downstream SAM2/geometry/optimization scripts remain real mechanisms.
